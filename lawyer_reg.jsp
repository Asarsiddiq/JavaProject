    ...
    try {
        ...
        if (btn.equals("Submit")) {
           ...
           if(email.matches(Email)){
                    String qry = "select max(id) as maxid from lawyer";
            ...
            String ins = "insert into lawyer values('"+id2+ "','" +name + "','" +cat + "','" +fees + "','" +contact + "','" + email + "','" + genter + "','" + address + "','"+ password  +"','0')";
...
<script language="javascript">
    alert("Data Not Save");
    window.location.href = "lawyer_reg.jsp";
</script>
<%
            }
...
<html lang="en">
  ...
  <tr>
    <td height="45" colspan="4"><div align="center" ><h1>Lawyer Register : </h1></div></td>
   </tr>
  
  <tr>
    <td width="25%" height="61">&nbsp;</td>
    <td width="25%"><div align="center" class="style2"><h2>Lawyer Name : </h2></div></td>
    <td width="14%"><input name="name" type="text" class="style2"></td>
    <td width="36%">&nbsp;</td>
  </tr>
   <tr>
    <td width="38%" height="61">&nbsp;</td>
    <td width="12%"><div align="center" class="style2"><h2>Lawyer Categories : </h2></div></td>
   
 <td> <select name="cat" id="genter" style="width:150px ">
    <option>Select</option>
    <% try{
    String qr="select * from cat";
    ResultSet rs = stmt1.executeQuery(qr); 
    while(rs.next()){
    %>
    <option><%=rs.getString("cat")%></option>
    ...
    %>
     ...
     <td width="36%">&nbsp;</td>
      ...
      <tr>
    <td width="38%" height="61">&nbsp;</td>
    <td width="12%"><div align="center" class="style2"><h2>Fees :</h2> </div></td>
    <td width="14%"><input name="fees" type="text" class="style2"></td>
    <td width="36%">&nbsp;</td>
  </tr>
  <tr>
    <td width="38%" height="61">&nbsp;</td>
  ...
  <tr>
    <td width="38%" height="61">&nbsp;</td>
    <td width="12%"><div align="center" class="style2"><h2>Genter : </h2></div></td>
